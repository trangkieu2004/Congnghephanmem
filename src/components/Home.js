  ...
  const feedbacks = [
    {
      name: "Nguyễn Anh Thư",
      comment:
        "Dịch vụ cắt lông tỉa tuyệt vời! Tôi cũng cảm thấy rất hài lòng với thái độ phục vụ tận tình của đội ngũ nhân viên.",
      imageUrl: cat1,
    },
    {
      name: "Trần Ngọc Anh",
      comment:
        "Tôi rất ấn tượng với dịch vụ ở đây. Qua trình đến là trải nghiệm thoải mái nhất mà tôi từng hài lòng.",
      imageUrl: cat2,
    },
    {
      name: "Phạm Hương",
      comment:
        "Dịch vụ tuyệt vời! Mọi thứ đều rất hoàn hảo từ bộ massage tới thái độ phục vụ.",
      imageUrl: cat3,
    },
  ];
        ...
        <div className="row justify-content-center">
          {feedbacks.map((feedback, index) => (
            <div key={index} className="col-md-4 mb-4">
              <div
                className="card text-center p-4 d-flex flex-column"
                style={{ height: "100%" }}
              >
                ...
                <p className="card-text textsize">{feedback.comment}</p>
              </div>
            </div>
          ))}
        </div></div>
